...
import com.jerio.security.core.validate.code.sms.SmsCodeSender;
...
//        ImageCode code = (ImageCode) imageCodeGenerator.generate(new ServletWebRequest(request));
...
//        smsCodeSender.send("",code.getCode());
//    }
